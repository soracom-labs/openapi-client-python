...
def get_api_config_on_production(auth_key: str, auth_key_id: str, coverage: Coverage) -> api.Configuration:
...
def get_api_config_on_sandbox(auth_key: str, auth_key_id: str) -> api.Configuration:
