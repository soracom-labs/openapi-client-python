...
class FilesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_exported_file_endpoint = _Endpoint(
            settings={
                'response_type': (GetExportedFileResponse,),
                'auth': [
                    'api_key',
                    'api_token'
                ],
                'endpoint_path': '/files/exported/{exported_file_id}',
    ...
    def get_exported_file(
        ...
        **kwargs
        ...
        """Get an exported file.  # noqa: E501

        Get an exported file. The `url` field in the response will contain a URL to download the exported file.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_exported_file(exported_file_id, async_req=True)
        >>> result = thread.get()
