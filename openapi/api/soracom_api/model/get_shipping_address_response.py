...
class GetShippingAddressResponse(ModelNormal):
    ...
    attribute_map = {
        ...
        'shipping_area': 'shippingArea',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address_line1, city, phone_number, shipping_address_id, shipping_area, state, zip_code, *args, **kwargs):  # noqa: E501
        """GetShippingAddressResponse - a model defined in OpenAPI
        ...
        self.shipping_area = shipping_area
        self.state = state
    ...
    @convert_js_args_to_python_args
    def __init__(self, address_line1, city, phone_number, shipping_address_id, shipping_area, state, zip_code, *args, **kwargs):  # noqa: E501
        """GetShippingAddressResponse - a model defined in OpenAPI
