...
class ShippingAddressModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, address_line1, city, state, zip_code, *args, **kwargs):  # noqa: E501
        """ShippingAddressModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, address_line1, city, state, zip_code, *args, **kwargs):  # noqa: E501
        """ShippingAddressModel - a model defined in OpenAPI
